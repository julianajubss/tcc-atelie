    ...
    switch ($action) {
        ...
        case 'create':
            ...
            if (!$title || $price === false || $price <= 0) {
                http_response_code(400);
                $response['message'] = 'Dados inválidos (verifique título e preço).';
                break;
            }
            ...
            $response = ['success' => true, 'message' => 'Producto criado com sucesso.', 'id' => $pdo->lastInsertId()];
            break;
        ...
        case 'delete':
            ...
            $stmt->execute([$id]);
            $response = ['success' => true, 'message' => 'Produto eliminado.'];
            break;

        default:
            http_response_code(400);
            $response['message'] = 'Ação desconocida.';
            break;
    }
} catch (Exception $e) {
    http_response_code(500);
